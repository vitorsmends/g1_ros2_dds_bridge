...
class LowStateToDogOdom(Node):
    def __init__(self):
        ...
        self.declare_parameter("dds_topic", "rt/lowstate")
        self.declare_parameter("ros_topic", "/dog_odom")
        ...
        self.pub = self.create_publisher(Odometry, ros_topic, qos)
        ...
        self.dds_sub = ChannelSubscriber(dds_topic, LowState_)
    ...
    def _dds_cb(self, msg: LowState_):
        ...
        q = [float(x) for x in msg.imu_state.quaternion]
        ...
        yaw = quat_to_yaw_xyzw(qx, qy, qz, qw)
